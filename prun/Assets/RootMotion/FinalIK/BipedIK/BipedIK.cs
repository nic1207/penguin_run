...
namespace RootMotion.FinalIK {
	...
	/// </summary>
	[AddComponentMenu("Scripts/RootMotion/IK/Biped IK")]
	public class BipedIK : SolverManager {
		...
		protected override void InitiateSolver() {
			if (!references.isValid) {
				if (Application.isPlaying) LogWarning("BipedIK references on '" + gameObject.name + "' contains one or more missing Transforms. Can not initiate BipedIK.");
				return;
			}
		...
		protected override void UpdateSolver() {
			...
			solvers.pelvis.UpdateConstraints();
