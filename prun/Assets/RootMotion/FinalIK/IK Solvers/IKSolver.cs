...
namespace RootMotion.FinalIK {
	...
	public abstract class IKSolver {
		...
		public class Point {
			...
			/// </summary>
			[HideInInspector] public Vector3 solverPosition;
			/// <summary>
		...
		public class Bone: Point {
			...
			/// <summary>
			/// The last solved local rotation.
			/// </summary>
			[HideInInspector] public Quaternion lastSolvedLocalRotation;
			/// <summary>
			...
			/// </summary>
			[HideInInspector] public Vector3 axis = -Vector3.right;
		...
		public class Node: Point {
			...
			/// </summary>
			[HideInInspector] public Quaternion solverRotation = Quaternion.identity;
			/// <summary>
			/// The effector position weight.
			/// </summary>
			[HideInInspector] public float effectorPositionWeight;
			/// <summary>
			/// The effector rotation weight.
			/// </summary>
			[HideInInspector] public float effectorRotationWeight;
			/// <summary>
			/// Position offset.
			/// </summary>
