...
namespace RootMotion.FinalIK {
	...
	public class IKSolverHeuristic: IKSolver {
		...
		/// <summary>
		/// Stores the default local positions of all bones.
		/// </summary>
		public void StoreDefaultLocalPositions() {
			for (int i = 0; i < bones.Length; i++) bones[i].defaultLocalPosition = bones[i].transform.localPosition;
		}
