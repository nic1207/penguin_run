...
namespace RootMotion {
	...
	public class Inspector {
		...
		public static void AddArray(SerializedContent content, bool editHierarchy, bool changeOrder, DrawArrayElement drawArrayElement = null, OnAddToArray onAddToArray = null, DrawArrayElementLabel drawArrayElementLabel = null, string style = "", bool showHeading = true) {
			...
			if (content.prop.isExpanded) {			
				for(int i = 0; i < content.prop.arraySize; i++) {
					...
					GUILayout.BeginVertical(style); // Style
