...
void main ()
{
  ...
  lowp vec4 c_5;
  c_5.xyz = ((tmpvar_2.xyz * _LightColor0.xyz) * (max (0.0, dot (xlv_TEXCOORD1, _WorldSpaceLightPos0.xyz)) * 2.0));
  c_5.w = tmpvar_3;
...
void main ()
{
  ...
  tmpvar_5 = tmpvar_10;
  lowp vec4 c_11;
  c_11.xyz = ((tmpvar_2.xyz * _LightColor0.xyz) * ((max (0.0, dot (xlv_TEXCOORD1, _WorldSpaceLightPos0.xyz)) * tmpvar_5) * 2.0));
  c_11.w = tmpvar_3;
  c_1.xyz = (c_11.xyz + (tmpvar_2.xyz * xlv_TEXCOORD2));
  c_1.w = tmpvar_3;
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  lowp vec4 c_5;
  c_5.xyz = ((tmpvar_2.xyz * _LightColor0.xyz) * ((max (0.0, dot (xlv_TEXCOORD1, _WorldSpaceLightPos0.xyz)) * texture2DProj (_ShadowMapTexture, xlv_TEXCOORD3).x) * 2.0));
  c_5.w = tmpvar_3;
  c_1.xyz = (c_5.xyz + (tmpvar_2.xyz * xlv_TEXCOORD2));
  c_1.w = tmpvar_3;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  c_1.xyz = (tmpvar_2.xyz * max (min (tmpvar_6, ((tmpvar_4.x * 2.0) * tmpvar_5.xyz)), (tmpvar_6 * tmpvar_4.x)));
  c_1.w = tmpvar_2.w;
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  tmpvar_9 = (tmpvar_2.xyz * max (min (lm_6, arg1_8), (lm_6 * tmpvar_4.x)));
  c_1.xyz = tmpvar_9;
  c_1.w = tmpvar_2.w;
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  shadow_5 = tmpvar_7;
  lowp vec4 c_8;
  c_8.xyz = ((tmpvar_2.xyz * _LightColor0.xyz) * ((max (0.0, dot (xlv_TEXCOORD1, _WorldSpaceLightPos0.xyz)) * shadow_5) * 2.0));
  c_8.w = tmpvar_3;
...
//   d3d11_9x - ALU: 5 to 11, TEX: 1 to 3, FLOW: 1 to 1
SubProgram "opengl " {
Keywords { "DIRECTIONAL" "LIGHTMAP_OFF" "DIRLIGHTMAP_OFF" "SHADOWS_OFF" }
...
void main ()
{
  ...
  lowp vec4 c_8;
  c_8.xyz = ((tmpvar_3.xyz * _LightColor0.xyz) * ((max (0.0, dot (xlv_TEXCOORD1, lightDir_2)) * texture2D (_LightTexture0, vec2(tmpvar_7)).w) * 2.0));
  c_8.w = tmpvar_4;
  c_1.xyz = c_8.xyz;
  c_1.w = tmpvar_4;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  lowp vec4 c_6;
  c_6.xyz = ((tmpvar_3.xyz * _LightColor0.xyz) * (max (0.0, dot (xlv_TEXCOORD1, lightDir_2)) * 2.0));
  c_6.w = tmpvar_4;
  c_1.xyz = c_6.xyz;
  c_1.w = tmpvar_4;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  lowp vec4 c_10;
  c_10.xyz = ((tmpvar_3.xyz * _LightColor0.xyz) * ((max (0.0, dot (xlv_TEXCOORD1, lightDir_2)) * atten_9) * 2.0));
  c_10.w = tmpvar_4;
  c_1.xyz = c_10.xyz;
  c_1.w = tmpvar_4;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  tmpvar_7 = dot (xlv_TEXCOORD3, xlv_TEXCOORD3);
  lowp vec4 c_8;
  c_8.xyz = ((tmpvar_3.xyz * _LightColor0.xyz) * ((max (0.0, dot (xlv_TEXCOORD1, lightDir_2)) * (texture2D (_LightTextureB0, vec2(tmpvar_7)).w * textureCube (_LightTexture0, xlv_TEXCOORD3).w)) * 2.0));
  c_8.w = tmpvar_4;
  c_1.xyz = c_8.xyz;
  c_1.w = tmpvar_4;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  lightDir_2 = xlv_TEXCOORD2;
  lowp vec4 c_6;
  c_6.xyz = ((tmpvar_3.xyz * _LightColor0.xyz) * ((max (0.0, dot (xlv_TEXCOORD1, lightDir_2)) * texture2D (_LightTexture0, xlv_TEXCOORD3).w) * 2.0));
  c_6.w = tmpvar_4;
  c_1.xyz = c_6.xyz;
  c_1.w = tmpvar_4;
  gl_FragData[0] = c_1;
...
//   d3d11 - ALU: 7 to 17, TEX: 1 to 3, FLOW: 1 to 1
//   d3d11_9x - ALU: 7 to 17, TEX: 1 to 3, FLOW: 1 to 1
SubProgram "opengl " {
Keywords { "POINT" }
...
"vs_360
backbbabaaaaabeiaaaaaamaaaaaaaaaaaaaaaceaaaaaaaaaaaaabaeaaaaaaaa
...

aaaaaaaaaaaaaaaa"
}
...
[Microcode]
144
00001c6c009d320c013fc0c36041dffc401f9c6c011d2808010400d740619f9c
401f9c6c01d0300d8106c0c360403f80401f9c6c01d0200d8106c0c360405f80
401f9c6c01d0100d8106c0c360409f80401f9c6c01d0000d8106c0c360411f80
